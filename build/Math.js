...
function math() {
    ...
    var generateProblemBtn = document.createElement("button");
    var score = 0;
    var question;
    ...
    var correctAnswer = 0;
    generateProblemBtn.addEventListener("click", function (e) {
        e.preventDefault();
        var scoreBox = document.createElement('div');
        var randomNum1 = Math.floor(Math.random() * 11);
        var randomNum2 = Math.floor(Math.random() * 11);
        var randomOperandGeneration = Math.floor(Math.random() * 4) + 0;
        var operandSymbol = operands[randomOperandGeneration];
        ...
        if (operandSymbol === "+") {
            question = "What is ".concat(randomNum1, " ").concat(operandSymbol, " ").concat(randomNum2);
        ...
        var scoreChange = setInterval(function () {
            scoreBox.textContent = "Point(s): ".concat(score);
